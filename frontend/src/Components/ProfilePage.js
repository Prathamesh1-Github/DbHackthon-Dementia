            ...
            <MDBCard className="mb-4">
              <MDBCardBody>
                ...
                <MDBRow>
                  ...
                  <MDBCol sm="9">
                    <MDBCardText className="text-muted">Westminister, London, UK</MDBCardText>
                  </MDBCol>
                </MDBRow>
              </MDBCardBody>
            </MDBCard>
            ...
            <MDBRow>
              <MDBCol md="6">
                <MDBCard className="mb-4 mb-md-0">
                  <MDBCardBody>
                    <MDBCardText className="mb-4"><span className="text-primary font-italic me-1">Patient Pulse</span></MDBCardText>
                    <MDBCardText className="mb-1" style={{ fontSize: '.77rem' }}>Stress</MDBCardText>
                    <MDBProgress className="rounded">
                      <MDBProgressBar width={80} valuemin={0} valuemax={100} />
                    </MDBProgress>

                    <MDBCardText className="mt-4 mb-1" style={{ fontSize: '.77rem' }}>Anxiety</MDBCardText>
                    <MDBProgress className="rounded">
